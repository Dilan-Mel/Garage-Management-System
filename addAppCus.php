              ...
              <div class="header-bottom">
		          <div class="menu">
					    <ul>
							...
							<li class="active"><a href="bills.html">Create Appointment</a></li>
							<div class="clear"></div>
						</ul>
					</div>
		 		    <div class="clear"></div>
	...
	<div class="wrap">
			<div class="content" style="position:relative; top:20px;>
				<div class="section group">
					...
					<form method="post" action=" " style="font-size:20px; font-family:arvo; font-weight:bold; padding-top:600px; padding-left:60px; color:#E5B840;">
						<tr>
						...
						<tr>
							<td><p style="color:#E5B840;  position:absolute; top:170px; left:750px;">Date : <div class="clear"></div>
						</tr>
						...
						<tr>
							<td><p style="color:#E5B840;  padding-top:30px; position:absolute; top:200px; left:750px;">Availability of Time : </p></td>
