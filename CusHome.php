<?php
include('displayLoyalPoints.php');
$dlp=new displayPoints();
$dlp->display();
	...
	<div class="wrap">
	    ...
	    <div class="content" style="position:relative; top:20px; padding-left:150px;">
	    	<h2>Home</h2>
						...
						<p style="font-size:25px; font-family:Rockwell Extra Bold; font-weight:bold; padding-top:30px; padding-left:60px; color:white; position:absolute; left:890px; top:20px; ">LOYALTY POINTS</p>
						<!--p style="font-size:45px; font-family:arvo; font-weight:bold; padding-top:30px; padding-left:60px; color:white; position:absolute; left:960px; top:60px; ">200</p>
						-->
						<?php
							$dp=new displayPoints();
							$dp->display();
						?>
	    	...
	    	<div class="section group">
				<div class="listview_1_of_2 images_1_of_2">
					...
					<div class="text list_2_of_1">
						<h3><a href="bills.php" >Bills</a></h3>
					</div>
					</div>			
				<div class="listview_1_of_2 images_1_of_2">
					<div class="listimg listimg_2_of_1">
					...
					<div class="text list_2_of_1">
						  <h3><a href="vHistory.php" >Vehicle History</a></h3>
						</div>
				</div>
			...
			<div class="section group">
				<div class="listview_1_of_2 images_1_of_2">
				    ...
				    <div class="text list_2_of_1">
						<h3><a href="View Status.php" >View Status</a></h3>
				...
				<div class="listview_1_of_2 images_1_of_2">
					...
					<div class="text list_2_of_1">
						  <h3><a href="addAppCus.php" >Add Appointments</a></h3>
						 </div>
				</div>
			</div>  
			<div class="section group">
				<div class="listview_1_of_2 images_1_of_2">
				    ...
				    <div class="text list_2_of_1">
						<h3><a href="UpdateCus.php" >Update personal Info</a></h3>
						</div>
			   </div>			
			<div class="listview_1_of_2 images_1_of_2">
					<div class="listimg listimg_2_of_1">
				    ...
				    <div class="text list_2_of_1">
						<h3><a href="cusappview.php" >View Added Appointments</a></h3>
						</div>
			   </div>	
