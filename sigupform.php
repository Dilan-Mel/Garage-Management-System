...
<div>
	...
	<a href='loginform.php'><input type='button' name='login' value='Login' style='position:absolute; top:5%; left:87%; background-color:ash; color:black; width:100px; height:30px; border-radius:45px; border-style:none;'></a>;
...
<div>		 
<p style="font-size:2em; color:#E5B840; padding:1px 20px; font-family: 'bebas_neueregular'; position:absolute; top:80%; left:34%">SIGN UP</style></p>
</div>		 
<div style="font-size:2em; color:#E5B840; padding:255px 20px; font-family: 'bebas_neueregular'; "> 
	...
	<table>
		<tr>
		<td style=" position:absolute; top:90%; left:35%;"><input type="text" name="email" placeholder="Email" size="50%"; style="height:30px; border-radius:45px;  border-style:none; font-size:15px; "></td>
		</tr>
		
		<tr>
		<td style=" position:absolute; top:100%; left:35%;"><input type="password" name="password" placeholder="Password" size="50%" style="height:30px; border-radius:45px;  border-style:none; font-size:15px; "></td>
		</tr>
		
		<tr>
		<td style=" position:absolute; top:110%; left:35%;"><input type="password" name="repassword" placeholder="Re-enter Password" size="50%" style="height:30px; border-radius:45px;  border-style:none; font-size:15px; "></td>
		</tr>
		
		<tr>
		<td style=" position:absolute; top:120%; left:35%;"><input type="text" name="name" placeholder="Name" size="50%"; style="height:30px; border-radius:45px;  border-style:none; font-size:15px; "></td>
		</tr>
		
		
		<tr>
		<td style=" position:absolute; top:130%; left:35%;"><input type="text" name="phone" placeholder="Contact Number" size="50%" style="height:30px; border-radius:45px;  border-style:none; font-size:15px; "></td>
		</tr>
		
		<tr>
		<td style=" position:absolute; top:140%; left:35%;"><input type="text" name="address" placeholder="Address" size="50%" style="height:30px; border-radius:45px;  border-style:none; font-size:15px; "></td>
		</tr>
		
		<tr>
		<td style=" position:absolute; top:150%; left:35%;"><input type="text" name="plateno" placeholder="Plate Number" size="50%" style="height:30px; border-radius:45px;  border-style:none; font-size:15px; "></td>
		</tr>
		
		<tr>
		<td style=" position:absolute; top:150%; left:70%;"><input type="submit" name="signupbutton" value="Sign Up" style="background-color:grey; color:black; width:100px; height:30px; border-radius:45px; border-style:none;"></td>
		</tr>
