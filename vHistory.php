              ...
              <div class="header-bottom">
		          <div class="menu">
					    <ul>
							...
							<li class="active"><a href="vHistory.html">Vehicle History</a></li>
							<div class="clear"></div>
						</ul>
					</div>
		 		    <div class="clear"></div>
	    ...
	    <div class="content" style="position:relative; top:20px; padding-left:150px;">
	    	...
	    	<div class="section group">
				<div class="listview_1_of_2 images_1_of_2">
					...
					<div class="text list_2_of_1">
						<h3><a href="Job History.php" >Job History</a></h3>
					</div>
					</div>			
				<div class="listview_1_of_2 images_1_of_2">
					<div class="listimg listimg_2_of_1">
					...
					<div class="text list_2_of_1">
						  <h3><a href="Status History.php" >Status History</a></h3>
						</div>
				</div>
			...
			<div class="section group">
				<div class="listview_1_of_2 images_1_of_2">
				    ...
				    <div class="text list_2_of_1">
						<h3><a href="partsAny.php" >Parts Analyzation</a></h3>
				...
				<!--div class="listview_1_of_2 images_1_of_2">
					...
					<div class="text list_2_of_1">
						  <h3><a href="lolHistory.html" >Loyalty Points History</a></h3>
						 </div>
				</div>
			</div>  
			<div class="section group">
				<div class="listview_1_of_2 images_1_of_2">
				    ...
				    <div class="text list_2_of_1">
						<h3><a href="Customer History.html" >Customer History</a></h3>
						</div-->
			   </div>			
