              ...
              <div class="header-bottom">
		          <div class="menu">
					    <ul>
							...
							<li class="active"><a href="UpdateCus.html">Update Personal Info</a></li>
							<div class="clear"></div>
						</ul>
					</div>
		 		    <div class="clear"></div>
	...
	<div class="wrap">
			<div class="content" style="position:relative; top:20px;>
				<div class="section group">
					<div class="heading">								
						<h4 style="position:relative; left:-50px;">Update Customer</h4>
					...
					<form method="post" action=" " style="font-size:20px; font-family:arvo; font-weight:bold; padding-top:30px; padding-left:60px; color:#E5B840;">
						<!--tr>
							<td><p style="color:#E5B840;">Customer ID : <input style="position:absolute; top:125px; left:320px;" type="text"></p></td>
						</tr>
						<tr>
						...
						<div class="clear"></div>
						<tr>
							<td><p style="color:#E5B840; padding-top:30px;">Plate Number : <input style="position:absolute; top:230px; left:320px;" type="text"></p></td>
						</tr>
						<div class="clear"></div>
						<tr>
							<td><p style="color:#E5B840;  padding-top:30px;">Username : <input style="position:absolute; top:285px; left:320px;" type="text"></p></td>
						</tr>
						<div class="clear"></div>
						<div class="clear"></div>
						<tr>
							<td><p style="color:#E5B840;  padding-top:30px;">Password: <input style="position:absolute; top:340px; left:320px;" type="text"></p></td>
						</tr>
						<div class="clear"></div>
						<div class="clear"></div>
						<tr>
							<td><p style="color:#E5B840;  padding-top:30px;">Date Of Birth : <input style="position:absolute; top:390px; left:320px;" type="text"></p></td>
						</tr-->
						<div class="clear"></div>
						<div class="clear"></div>
						<tr>
							<td><p style="color:#E5B840;  padding-top:30px;">Address : <input style="position:absolute; top:155px; left:200px;" type="text" name='add'></p></td>
						</tr>
						<div class="clear"></div>
						<tr>
							<td><p style="color:#E5B840;  padding-top:30px;">Phone : <input style="position:absolute; top:205px; left:200px;" type="text" name='phn'></p></td>
						</tr>
						<div class="clear"></div>
						<tr>
							<td><p style="color:#E5B840;  padding-top:30px;">Email: <input style="position:absolute; top:258px; left:200px;" type="text" name='mail'></p></td>
						</tr>
						<div class="clear"></div>
						...
						<tr>
							<td><input type='submit' name='upcus' value='Update Customer' style='width:150px; height:30px; border-radius:45px; border-style:none; font-family:avro; font-size:16px; position:absolute; left:400px; top:258px;'></td>
						</tr>
						<div class="clear"></div>
						...
						<tr>
							<td><p style="color:#E5B840;  position:absolute; top:100px; left:700px;">ADD A VEHICLE</p></td>
						</tr>
						<div class="clear"></div>
					
						
						<tr>
							<td><p style="color:#E5B840;  position:absolute; top:150px; left:700px;">Plate Number : <input style="position:absolute; top:1px; left:170px; z-index:99999;" type="text" name='pno'></p></td>
						</tr>
						<div class="clear"></div>
						...
						<tr>
							<td><input type='submit' name='addv' value='Add' style='width:100px; height:30px; border-radius:45px; border-style:none; font-family:avro; font-size:16px; position:absolute; left:920px; top:200px;'></td>
						</tr>
						<div class="clear"></div>
...
if(($_SERVER['REQUEST_METHOD'])=='POST')
{
	if(isset($_POST['upcus']))
	{
		...
		if(empty($add)||empty($phn)||empty($email))
		{
			echo"<script>alert('One or more feilds empty')</script>";
		}
		else
		{
		
			$ucus=new updatecus();
			$ucus->Update($add,$phn,$email);
		}
	}
	...
	if(isset($_POST['addv']))
	{
		...
		if(empty($plate))
		{
			echo"<script>alert('Enter the plate number')</script>";
		}
